/*
* Сущности используются в слое доступа к данным (DAL) для взаимодействия с базой данных.
*  Они представляют собой объекты, которые соответствуют таблицам в базе данных.
*  Сущности содержат поля, которые соответствуют столбцам в таблице.
* */
